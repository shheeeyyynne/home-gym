          ...
          <div className="relative mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
              ...
              <div className="bg-grey-900 rounded-xl p-6 shadow-lg">
                ...
                />
                <div className="mb-4">
                  <h3 className="text-white text-[24px] font-bold mb-2 min-h-[60px]">Balance & Stability</h3>
                  <p className="text-grey-300 text-[14px] font-light mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <div className="flex items-center gap-2">
                      <span className="text-white text-[16px] font-medium">Learn More</span>
                      <img
                        alt="Arrow13358"
              ...
              <div className="bg-grey-900 rounded-xl p-6 shadow-lg">
                ...
                />
                <div className="mb-4">
                  <h3 className="text-white text-[24px] font-bold mb-2 min-h-[60px]">Cardio Equipment</h3>
                  <p className="text-grey-300 text-[14px] font-light mb-4">
              ...
              <div className="bg-grey-900 rounded-xl p-6 shadow-lg">
                ...
                />
                <div className="mb-4">
                  <h3 className="text-white text-[24px] font-bold mb-2 min-h-[60px]">Weights & Dumbbells</h3>
                  <p className="text-grey-300 text-[14px] font-light mb-4">
              ...
              <div className="bg-grey-900 rounded-xl p-6 shadow-lg">
                ...
                />
                <div className="mb-4">
                  <h3 className="text-white text-[24px] font-bold mb-2 min-h-[60px]">Yoga & Flexibility</h3>
                  <p className="text-grey-300 text-[14px] font-light mb-4">
